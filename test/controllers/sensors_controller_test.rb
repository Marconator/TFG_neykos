...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { gateway_status_id: @sensor.gateway_status_id, sensor_id: @sensor.sensor_id } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { gateway_status_id: @sensor.gateway_status_id, sensor_id: @sensor.sensor_id } }
